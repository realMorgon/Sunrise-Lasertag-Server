...
def calculateTime(clientid, clienttime):
	return devices.get(clientid).get_time() + clienttime
...
def get_data():
    ...
    device_time = devices.get(device_id).get_time()
...
def send_hit():
    ...
    gametime = calculateTime(client_id, client_time)
